...
function exchange(state = {}, action) {
  ...
  switch (action.type) {
    ...
    case 'ORDER_FILL_FAILED':
      return { ...state, orderFilling: false }
    ...
    case 'BUY_ORDER_MAKING_ERROR':
      return { ...state, buyOrder: { ...state.buyOrder, making: false } }
    case 'SELL_ORDER_MAKING_ERROR':
      return { ...state, sellOrder: { ...state.sellOrder, making: false } }
